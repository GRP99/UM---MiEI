...
var client = hl7.Server.createTcpClient('localhost', 6969);
            ...
            mysqlConnection.query(sql, (err, results, fields) => {
                if (!err) {
                    results.forEach(element => {
                        ...
                        var message = criarMensagemPedido(element, order_status);
...
function createMSH(pedido) {
    return new hl7.Message( // '^~\&', //MSH.1 - Field Separator	1 [DEFAULT]
            ...
            'AppA', // MSH.3 - Sending Application	227
            'AppA', // MSH.4 - Sending Facility	227
            'AppB', // MSH.5 - Receiving Application	227
            'AppB', // MSH.6 - Receiving Facility	227
