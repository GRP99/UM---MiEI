...
def createCSV(dict_wine: dict):
    with open('./Regression/winequality-regression.csv', mode='w', encoding='utf8', newline='') as csv_file:
...
def main():
    ...
    print(f'File winequality-regression.csv created with {len(dict_wine)} instances!')
