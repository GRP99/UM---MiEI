...
public class Review {
    ...
    private final String date_first;
    private final String date_last;
    private final String scores_rating;
    private final String scores_accuracy;
    private final String scores_cleanliness;
    private final String scores_checking;
    private final String scores_communication;
    private final String scores_location;
    private final String scores_value;
    private final String reviews_per_month;
