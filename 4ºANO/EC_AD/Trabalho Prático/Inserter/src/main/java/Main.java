            ...
            while ((line = in.readLine()) != null) {
                ...
                for (String ver : amenities_fields) {
                    if (!amenities.containsKey(ver)) {
                        ...
                        String insert = "insert into dim_amenity values (" + amenities_counter + ",'" + ver + "');";
                        out.println(insert);
                        out.flush();
                    }
                }
                ...
                String insert = "insert into fact_AIRBNB values (" + facts.getId() + "," + facts.getExperience() + "," + facts.getHost() + "," + facts.getLocation() + "," + facts.getInstallation() + "," + facts.getPrice() + "," + facts.getWeekly_price() + "," + facts.getMonthly_price() + "," + facts.getSecurity_deposit() + "," + facts.getCleaning_fee() + "," + facts.getGuests() + "," + facts.getExtras() + "," + facts.getMinimum_nights() + "," + facts.getAvailability() + "," + facts.getReviews() + "," + facts.getCancellationpolicy() + ");";
                out.println(insert);
                out.flush();
