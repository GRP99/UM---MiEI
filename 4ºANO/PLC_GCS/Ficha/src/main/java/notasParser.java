...
public class notasParser extends Parser {
	...
	public static class TurmasContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterTurmas(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitTurmas(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitTurmas(this);
	...
	public static class TurmaContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterTurma(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitTurma(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitTurma(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AlunosContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterAlunos(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitAlunos(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitAlunos(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AlunoContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterAluno(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitAluno(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitAluno(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NomeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterNome(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitNome(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitNome(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NotasContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).enterNotas(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof notasListener ) ((notasListener)listener).exitNotas(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof notasVisitor ) return ((notasVisitor<? extends T>)visitor).visitNotas(this);
			else return visitor.visitChildren(this);
		}
	}
