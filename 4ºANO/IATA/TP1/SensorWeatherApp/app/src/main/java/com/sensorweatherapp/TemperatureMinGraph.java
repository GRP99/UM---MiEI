...
public class TemperatureMinGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperaturemingraph);
        ...
        this.series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                ...
                Toast.makeText(TemperatureMinGraph.this, msg, Toast.LENGTH_LONG).show();
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot openWeatherSnapshot : snapshot.getChildren()) {
                    OpenWeather ow = openWeatherSnapshot.getValue(OpenWeather.class);
                    if (ow.getCity().equals(city)) {
                        dp[index] = new DataPoint(ow.getLdt(), ow.getTemperatureMin());
                        index++;
                    }
                }
                series.resetData(dp);
