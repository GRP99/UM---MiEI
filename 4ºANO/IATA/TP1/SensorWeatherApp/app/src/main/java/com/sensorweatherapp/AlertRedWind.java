...
public class AlertRedWind extends AppCompatDialogFragment {

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

        String titleText = "Very High Wind speed";
        ...
        String message = "Extreme risk meteorological situation." + "\n" + "Regularly keep up to date with changing weather conditions and follow the guidelines of the authorities.";
