...
public class AlertExtremeDangerHeat extends AppCompatDialogFragment {

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

        String titleText = "Temperature: Extreme Danger";
        ...
        String message = "Overheating and impending heat cramps...";
