...
public class AlertExtremeCautionHeat extends AppCompatDialogFragment {

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

        String titleText = "Temperature: Extreme Caution";
        ...
        String message = "Overheating and possible heat cramps...";
