...
public class AlertModerateUV extends AppCompatDialogFragment {

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

        String titleText = "UV Index: Moderate";
        ...
        String message = "A UV index reading of 3 to 5 means moderate risk of harm from unprotected sun exposure.";
