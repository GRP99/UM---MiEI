...
void prepareCilinder(float height, float radius, int sides) {
    ...
    glGenBuffers(1, &vnormais);
    glBindBuffer(GL_ARRAY_BUFFER, vnormais);
...
void renderScene(void) {
    ...
    // posicao da luz , e afetada pelas transformacoes por isso temos de a por sempre de volta no mesmo sitio
...
void initGL() {
    ...
    glEnableClientState(GL_NORMAL_ARRAY); // vetores normais
