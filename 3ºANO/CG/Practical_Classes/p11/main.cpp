...
void prepareCylinder(float altura, float raio, int lados) {
	...
	float centro_cimaX = 0.4375, centro_cimaY = 0.1875;
	float centro_baixoX = 0.8125, centro_baixoY = 0.1875;
	float intervalos = (float)1 / lados;
	float quantoandou = 0;
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex * 2 + 0] = centro_cimaX;
		t[vertex * 2 + 1] = centro_cimaY;
		...
		t[vertex * 2 + 0] = centro_cimaX + (0.1875 * (cos(i * delta)));
		t[vertex * 2 + 1] = centro_cimaY + (0.1875 * (sin(i * delta)));
		...
		t[vertex * 2 + 0] = centro_cimaX + (0.1875 * (cos((i+1) * delta)));
		t[vertex * 2 + 1] = centro_cimaY + (0.1875 * (sin((i+1) * delta)));
		...
		t[vertex * 2 + 0] = quantoandou + intervalos;
		t[vertex * 2 + 1] = 1;
		...
		t[vertex * 2 + 0] = centro_baixoX;
		t[vertex * 2 + 0] = centro_baixoY;
		...
		t[vertex * 2 + 0] = centro_baixoX + (0.1875 * (cos((i+1) * delta)));
		t[vertex * 2 + 1] = centro_baixoY + (0.1875 * (sin((i+1) * delta)));
		...
		t[vertex * 2 + 0] = centro_baixoX + (0.1875 * (cos(i * delta)));
		t[vertex * 2 + 1] = centro_baixoY + (0.1875 * (sin(i * delta)));
...
int main(int argc, char** argv) {
	...
	// registo da funoeses do teclado e rato
