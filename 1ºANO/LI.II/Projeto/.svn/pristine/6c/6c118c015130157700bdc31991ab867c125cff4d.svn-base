...
*/
#define ABRIR_SVG(tamx, tamy)				printf("<center><svg width=%d height=%d>\n", tamx, tamy)
/**
\brief Macro para fechar um svg
*/
#define FECHAR_SVG							printf("</svg></center>\n")
/**
...
/**
\brief Macro para criar um texto
@param X A coordenada X do canto superior esquerdo
@param Y A coordenada Y do canto superior esquerdo
@param ESCALA A escala da imagem
@param TEXTO para escrever do ficheiro
*/
#define TEXTO(X, Y, TEXTO)		printf("<text x=%d y=%d fill=\"%s\" > %s /text>\n", \
											X, Y, TEXTO)
/**
