public class LinhaEncomenda{
    ...
    public boolean equals(Object obj) {
        ...
        return le.getReferencia().equals(this.referencia) && le.getDescricao().equals(this.descricao) && le.getPreco() == this.preco && le.getQuantidade() == this.quantidade && le.getDesconto() == this.desconto && le.getImposto() == this.imposto;
    }
