...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{auxIn}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{auxIn}\mathbin{::}(\Conid{Op},(\Conid{Expr},\Conid{Expr}))\to \Conid{Expr}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{auxIn}\;(\Varid{o},(e_1 ,e_2 ))\mathrel{=}\Conid{Bop}\;e_1 \;\Varid{o}\;e_2 {}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\N_0+(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr}))}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{calcula}\times\Varid{calcula}))}}         
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0+(\Conid{Op},(\N_0,\N_0))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{id},\Varid{magic}\mskip1.5mu]}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{magic}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{magic}\mathbin{::}(\Conid{Op},(\Conid{Int},\Conid{Int}))\to \Conid{Int}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{magic}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(i_1,i_2))\mathrel{=}i_1\mathbin{+}i_2{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{magic}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(i_1,i_2))\mathrel{=}i_1\mathbin{*}i_2{}\<[E]%
\ColumnHook
...
&
     \ensuremath{\N_0+(\Conid{Op},(\Conid{String},\Conid{String}))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{pretty},\Varid{express}\mskip1.5mu]}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{21}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{pretty}}{\Varid{express}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{pretty}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{pretty}\;\Varid{x}\mid \Varid{x}\geq \mathrm{0}\mathrel{=}\Varid{show}\;\Varid{x}{}\<[E]%
\\
\>[12]{}\hsindent{9}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{show}\;\Varid{x}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{express}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{express}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 +\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{express}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 *\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\ColumnHook
...
\\
\>[B]{}\Varid{compile}\mathrel{=}(\Varid{cataExpr}\;\alt{\Varid{pux}}{\Varid{opr}})\comp \Varid{read}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{pux}\mathbin{::}\Conid{Int}\to \Conid{Codigo}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{pux}\;\Varid{x}\mid \Varid{x}\geq \mathrm{0}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \Varid{show}\;\Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[12]{}\hsindent{6}{}\<[18]%
\>[18]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \text{\tt \char34 (\char34}\plus \Varid{show}\;\Varid{x}\plus \text{\tt \char34 )\char34}\mskip1.5mu]{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{opr}\mathbin{::}(\Conid{Op},(\Conid{Codigo},\Conid{Codigo}))\to \Conid{Codigo}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{opr}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{opr}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{aux}\mathbin{::}(\Varid{b},(\Conid{X}\;\Varid{a}\;\Varid{b},\Conid{X}\;\Varid{a}\;\Varid{b}))\to \Conid{X}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{aux}\;(\Varid{b0},(\Varid{x1},\Varid{x2}))\mathrel{=}\Conid{Comp}\;\Varid{b0}\;(\Varid{x1})\;(\Varid{x2}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{baseL2D}\;\Varid{f}\;\Varid{g}\;\Varid{h}{}\<[27]%
\>[27]{}\mathrel{=}\Varid{f}+(\Varid{g}{}\<[39]%
\>[39]{}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
...
\column{18}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{collectLeafs}\mathbin{::}{}\<[18]%
\>[18]{}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}\to [\mskip1.5mu \Conid{Caixa}\mskip1.5mu]{}\<[E]%
\\
...
\column{38}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{intToFloat}\mathbin{::}(\Conid{Int},\Conid{Int})\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{intToFloat}\;(\Varid{g},\Varid{p})\mathrel{=}(\Varid{fromInteger}\;(\Varid{toInteger}\;\Varid{g}),\Varid{fromInteger}\;(\Varid{toInteger}\;\Varid{p})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{toString}\;\Conid{V}\mathrel{=}\text{\tt \char34 V\char34}{}\<[E]%
\\
\>[B]{}\Varid{toString}\;\Conid{Vd}\mathrel{=}\text{\tt \char34 Vd\char34}{}\<[E]%
\\
\>[B]{}\Varid{toString}\;\Conid{Ve}\mathrel{=}\text{\tt \char34 Ve\char34}{}\<[E]%
\\
\>[B]{}\Varid{toString}\;\Conid{H}\mathrel{=}\text{\tt \char34 H\char34}{}\<[E]%
\\
\>[B]{}\Varid{toString}\;\Conid{Hb}\mathrel{=}\text{\tt \char34 Hb\char34}{}\<[E]%
\\
\>[B]{}\Varid{toString}\;\Conid{Ht}\mathrel{=}\text{\tt \char34 Ht\char34}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\;(\Conid{Unid}\;\Varid{g})\mathrel{=}\Varid{intToFloat}\;(\p1\;\Varid{g}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\;(\Conid{Comp}\;\Varid{g}\;\Varid{r}\;\Varid{p})\mathrel{=}\Varid{compareDim}\;(\Varid{toString}\;\Varid{g})\;(\Varid{dimen}\;\Varid{r})\;(\Varid{dimen}\;\Varid{p}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{compareDim}\mathbin{::}\Conid{String}\to (\Conid{Float},\Conid{Float})\to (\Conid{Float},\Conid{Float})\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{compareDim}\;\Varid{s}\;(\Varid{a},\Varid{b})\;(\Varid{y},\Varid{z})\mid \Varid{s}\equiv \text{\tt \char34 H\char34}\mathrel{\vee}\Varid{s}\equiv \text{\tt \char34 Hb\char34}\mathrel{\vee}\Varid{s}\equiv \text{\tt \char34 Ht\char34}\mathrel{=}(\Varid{a}\mathbin{+}\Varid{y},(\Varid{max}\;\Varid{b}\;\Varid{z})){}\<[E]%
\\
\>[13]{}\hsindent{25}{}\<[38]%
\>[38]{}\mid \Varid{s}\equiv \text{\tt \char34 V\char34}\mathrel{\vee}\Varid{s}\equiv \text{\tt \char34 Ve\char34}\mathrel{\vee}\Varid{s}\equiv \text{\tt \char34 Vd\char34}\mathrel{=}((\Varid{max}\;\Varid{a}\;\Varid{y}),\Varid{b}\mathbin{+}\Varid{z}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[9]{}(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}((\Varid{x}\mathbin{/}\mathrm{2})\mathbin{-}(\Varid{a}\mathbin{/}\mathrm{2}),\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ve}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\mathrm{0},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Vd}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{-}\Varid{a},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Hb}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ht}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{-}\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{H}\;{}\<[9]%
\>[9]{}(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},(\Varid{y}\mathbin{/}\mathrm{2})\mathbin{-}(\Varid{b}\mathbin{/}\mathrm{2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calcOri}\mathbin{::}((\Conid{Tipo},(\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo},\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo})),\Conid{Origem})\to ((),((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo},\Conid{Origem}),(\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo},\Conid{Origem}))){}\<[E]%
\\
\>[B]{}\Varid{calcOri}\;((\Varid{tip},(\Varid{c1},\Varid{c2})),\Varid{or})\mathrel{=}((),((\Varid{c1},\Varid{or1}),(\Varid{c2},\Varid{or2}))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{or1}\mathrel{=}\Varid{calc}\;\Varid{tip}\;\Varid{or}\;(\Varid{dimen}\;\Varid{c1}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{or2}\mathrel{=}\Varid{calc}\;\Varid{tip}\;\Varid{or}\;(\Varid{dimen}\;\Varid{c2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\mathrel{=}\Varid{anaL2D}\;((\Varid{id}+\Varid{calcOri})\comp \Varid{distl}\comp (\Varid{outL2D}\times\Varid{id})){}\<[E]%
\\[\blanklineskip]%
...
Pretende-se implementar um ciclo que implemente o cálculo da aproximação até \ensuremath{\Varid{i}\mathrel{=}\Varid{n}} da série de Taylor da função coseno:
...
\\
     \ensuremath{\Conid{B}}
&
     \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{B}))\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\Varid{func}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{func}\mathrel{=}(\Varid{foldr}\;(\mathrel{\wedge})\;(\Conid{True})\comp (\map \;(\alt{\underline{\Conid{True}}}{\Varid{id}}\comp \p2))){}\<[E]%
\\[\blanklineskip]%
